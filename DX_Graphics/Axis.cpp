...
HRESULT Axis::CreateBuffer()
{
	...
	PCVertex axis[] =
	{
		{Vector3D(0.f, 0.f, 0.f),	Vector4D(Color::Red),},
		{Vector3D(15.f, 0.f, 0.f), Vector4D(Color::Red),},

		{Vector3D(0.f, 0.f, 0.f),	Vector4D(Color::Green),},
		{Vector3D(0.f ,15.f, 0.f), Vector4D(Color::Green),},

		{Vector3D(0.f, 0.f, 0.f),	Vector4D(Color::Blue),},
		{Vector3D(0.f ,0.f, 15.f), Vector4D(Color::Blue),},
	};
